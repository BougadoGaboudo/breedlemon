...
export default function PrimaryButton({
  ...
  const stateClass = disabled
    ...
    : isSelected
      ...
      : `border border-primary-500 bg-primary-500 ${theme === "dark" ? "text-light-500" : "text-dark-500"} cursor-pointer hover:bg-dark-500 hover:text-primary-500 hover:border-dark-500`;
